...
const About = () => {
  return (
    <div className='px-5 flex flex-col w-fit m-auto my-15 max-w-xl' id='About'>
      <motion.h1 initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.4 }} whileInView={{ opacity: 1, y: 0 }} className='font-semibold text-primaryTextColor text-xl my-5'>
        About Me
      </motion.h1>
      <motion.p initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.4 }} whileInView={{ opacity: 1, y: 0 }} className=' text-xs md:text-sm px-2 self-center max-w-xl'>
      ...
      <main className='text-black font-semibold flex flex-col gap-3 my-5 relative'>
        <motion.section initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.4 }} whileInView={{ opacity: 1, y: 0 }} className='flex gap-3 justify-center'>
