...
const ContactLinks = () => {
  return (
    <div className='text-2xl md:text-4xl gap-2 flex '>
      ...
      <button className='bg-transparent hover:scale-125 transition-all duration-[150ms] hover:text-blue-600 focus:outline-none' onClick={()=>{window.open('https://www.linkedin.com/in/pholibert-lim-37a51323b/', '_blank')}}>
