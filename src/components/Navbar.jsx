...
const Navbar = () => {
  ...
  return (
    <div className='bg-sky-700 p-5 flex justify-between w-full'>
      <Logo />
      ...
      <section className='flex flex-col md:hidden'>
        ...
        {open && (
          <nav className=' flex flex-col items-center gap-5 p-5 absolute right-2 top-[98px] bg-sky-700 rounded-md w-40 z-10'>
